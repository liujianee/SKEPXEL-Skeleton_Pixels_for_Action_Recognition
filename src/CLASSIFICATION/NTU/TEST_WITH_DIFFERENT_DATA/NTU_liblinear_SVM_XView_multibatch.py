...
#work_dir = './SKEL_Output_COMPARE_Features_SuperPixel_5x5_36x36_Skeleton/'
work_dir = './SKEL_Output_COMPARE_Features_SuperPixel_5x5_36x36_Skel_Velo_Sandwich/'

#work_dir = './SKEL_Output_S015_Joint_Argmt_Comparison/'
...
np.save('liblinear_SVM_score_SKEL_VELO_XView', score_arr)
